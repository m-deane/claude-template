module.exports = function buildS7toS10(pres, C, h) {
  ...
  // ----------------------------------------------------------
  // Slide 40: Section Divider — Business Use Cases
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.navy };
  ...
  // ----------------------------------------------------------
  // Slide 41: Four AI-Enhanced Platforms Directly Relevant to FM&I
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.offWhite };
  ...
  // ----------------------------------------------------------
  // Slide 42: 16 Commercial Ideas for the Innovation Day Board
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.offWhite };
  ...
  // ----------------------------------------------------------
  // Slide 43: Section Divider — Closing Thoughts
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.navy };
  ...
  // ----------------------------------------------------------
  // Slide 47: Closing CTA — Three Things to Do Before Innovation Day
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.navy };

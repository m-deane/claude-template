/**
 * FM&I Gen AI Upskilling Session — PowerPoint Generator v5
 */
...
const buildS1toS3 = require(path.join(__dirname, "slides_s1_s3_v5.cjs"));
const buildS4toS6 = require(path.join(__dirname, "slides_s4_s6_v5.cjs"));
const buildS7toS10 = require(path.join(__dirname, "slides_s7_s10_v5.cjs"));
buildS1toS3(pres, C, h);
buildS4toS6(pres, C, h);
buildS7toS10(pres, C, h);
pres.writeFile({fileName: "gen_ai_fmi_presentation_v5.pptx"})
  .then(() => console.log("✅ gen_ai_fmi_presentation_v5.pptx generated successfully."))

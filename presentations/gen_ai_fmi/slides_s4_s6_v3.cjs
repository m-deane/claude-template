module.exports = function buildS4toS6(pres, C, h) {
  ...
  // ----------------------------------------------------------
  // Slide 22: Both Tools Are Shipping Major Upgrades in 2026
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.offWhite };
  ...
  // ----------------------------------------------------------
  // Slide 23: Section Divider — The Model Landscape
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.navy };
  ...
  // ----------------------------------------------------------
  // Slide 24: The Models You Knew a Year Ago Are Not the Models Available Today
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.offWhite };
  ...
  // ----------------------------------------------------------
  // Slide 25: Different Models Excel at Different Tasks
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.offWhite };
  ...
  // ----------------------------------------------------------
  // Slide 26: A Simple Decision Framework for Model Selection
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.offWhite };
  ...
  // ----------------------------------------------------------
  // Slide 27: Section Divider — Ethics & Compliance
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.navy };
  ...
  // ----------------------------------------------------------
  // Slide 28: The Data Boundary Is the Most Important Thing in This Session
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.offWhite };
  ...
  // ----------------------------------------------------------
  // Slide 29: Five Rules Cover 95% of Situations — Memorise These
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.offWhite };
  ...
  // ----------------------------------------------------------
  // Slide 30: Not All AI Tools Handle Your Data the Same Way
  // ----------------------------------------------------------
  {
    const s = pres.addSlide();
    s.background = { color: C.offWhite };

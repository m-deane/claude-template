...
Update project documentation systematically for the specified doc type, implementation status, API changes, or full synchronization.

## Current Documentation State

Before starting, review the current documentation:
- Examine the documentation structure and existing markdown files
- Check specs directory if it exists
- Review implementation status indicators across docs
- Review recent documentation changes in git history
- Check project-level documentation (CLAUDE.md, README.md)
...
1. Update phase implementation document:
   - Mark completed tasks with status indicators
...
3. Update implementation specification documents:
   - Mark completed items with status indicators but preserve original requirements
...
Refer to @project-instructions for project-specific documentation conventions.

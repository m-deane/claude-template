...
Auto-generate API reference documentation for the specified output format (Swagger UI, Redoc, Postman, Insomnia, or multi-format).

## Current API Infrastructure

Before starting, review the project to understand:
- Existing code annotations (@api, @swagger, @doc patterns)
- API framework in use (check package.json or imports)
- Existing API spec files (OpenAPI, Swagger)
...
Refer to @project-instructions for project-specific API documentation conventions.

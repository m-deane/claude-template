...
Intelligently refactor and improve code quality for the specified file, component, or scope.

## Instructions

Follow this systematic approach to refactor the code:
...
Refer to @project-instructions for project-specific conventions and rules.

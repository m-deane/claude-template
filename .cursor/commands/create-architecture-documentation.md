...
Generate comprehensive architecture documentation for the specified framework, model type, or full suite.
...
- Service definitions (docker-compose.yml, k8s configs)
...
Refer to @project-instructions for project-specific architecture conventions.
